...
Comisión: Dr. Pablo Pérez Ahumada y ]
...
En las últimas décadas, Chile ha experimentado una .bold[revitalización de la movilización social] .tiny[*(Donoso & von Bulow, 2017; Somma et al., 2021)*]
...
1) .bold[Resurgimiento] de la conflictividad social alrededor del mundo .tiny[*(Della Porta et al., 2017)*] 

]

--
.box-inv-4.mlarge.sp-after[
2) Renovada crítica contra la desigualdad .tiny[*(Blühdorn & Deflorian, 2021)*]
]

--
.box-inv-4.medium.sp-after[
3) Múltiples fuentes/motivos .tiny[*(Della Porta & Diani, 2006; Inglehart, 2018)*]
]

--
.box-inv-4.medium.sp-after[
4) .bold[Re-politización] de las desigualdades y .bold[revitalización] de los conflictos distributivos .tiny[*(Bernburg, 2016; Della Porta, 2015)*]
]
...
* La .bold[participación en organizaciones sociopolíticas] tiene un efecto potenciador en el conflicto percibido y en la participación de acciones contenciosas .tiny[*(Kerrissey & Schofer, 2018; Ringqvist, 2020)*]
...
--
* .bold[Desigualdad económica] incrementa el conflicto percibido, mientras que la prosperidad económica lo disminuye .tiny[*(Hadler, 2017; Hertel & Schöneck, 2019)*]

* .bold[Estados de Bienestar] más extensos se asocian con menos tensiones sociales .tiny[*(Edlund & Lindh, 2015)*]

* Mayor .bold[concertación política] y .bold[densidad sindical] disminuyen el conflicto laboral .tiny[*(Pérez, 2022; Ringqvist, 2020)*]

--

.center.bold.slarge[Sin embargo...]
