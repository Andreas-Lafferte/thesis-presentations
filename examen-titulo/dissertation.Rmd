...
> "... se debería haber definido de modo más preciso qué se entiende por intereses materiales, así como en qué medida la variable dependiente utilizada en este estudio puede ser un indicador de ellos"
...
> "... hay que ser más enfático al decir que las diferencias entre clases no son sustancialmente grandes... Más aún, sugiere la necesidad de explicar por qué esas diferencias no son tan grandes"
...
- **Resultados mejoran** → Replicación análisis con Top 10% de participación del ingreso (con Gini se mantienen). _¿Mientras más extrema la concentración del ingreso, mayor conflicto?_
...
plot_model(mgini_1,
           ...
           axis.labels = c("Ola 2019",
                           "Ola 2009",
                           "Indice Corporativismo",
                           "Gini",
                           "Miembro Sindicato",
...
3. Evidencia para sostener que los efectos de la concentración del ingreso se refuerzan al medir su repartición en pequeños grupos poblacionales
