...
.center[
![:scale 55%](images/trend_protest1.png)
]
...
1) .bold[Resurgimiento] de la conflictividad social: tiempos contenciosos .tiny[*(Della Porta et al., 2017)*] 

]

--
.box-inv-4.mlarge.sp-after[
2) Renovada crítica contra la excesiva desigualdad: "We are the 99%" .tiny[*(Blühdorn & Deflorian, 2021)*]
]
...
* Estatus social subjetivo .tiny[*(Hertel and Schöneck, 2019)*]


* Creencias sobre la estratificación .tiny[*(Hertel and Schöneck, 2019; Kelley & Evans, 1995)*]
