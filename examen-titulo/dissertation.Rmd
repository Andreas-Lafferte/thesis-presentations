...
* Desigualdad y prosperidad económica .tiny[*(Hadler, 2017; Hertel & Schöneck, 2019)*]
...
- **Supuestos** → asumir que los indicadores capturan intereses opuestos → explanandum/explanans

- **Limitante** → asociada a los datos disponibles y ex-post ya que _sí_ mide la percepción de conflicto (validez de constructo ≠ contenido)

- **Avanzar en medición** → enfocarse en los _motivos_ de los conflictos antes que en los grupos
...
- **Mesurar conclusiones** → aunque hay apoyo a $H_1$ estas diferencias no son muy grandes

- **Posibles sospechosos** → replicación con indicadores de $PSCi$ por separado (logit multinivel) _no arroja diferencias más grandes_ entre los β (ej. Modelo RP Trabajadores no calificados: $\beta$ = 0.63; p < .01)

- **Implicancias** → _esta medida_ objetiva de clase no se asocia con grandes diferencias en cuanto a $PSCi$
...
- **Resultados mejoran** → Replicación análisis con Top 10% de participación del ingreso

- **Resultados interacción mejoran** → Replicación análisis con Top 10% implica un coeficiente más grande
...
--
1. Datos disponibles, avanzar en mejores formas de medición de las percepciones de conflicto

--

2. Matizar diferencias entre clases 
